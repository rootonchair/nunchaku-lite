...
def run_original_nunchaku(args: argparse.Namespace, output_dir: Path, pipeline_cls, torch_dtype: torch.dtype) -> dict:
    transformer_cls = import_original_nunchaku_class("NunchakuFluxTransformer2DModelV2")
    ...
    cleanup()
    print("loading original Nunchaku Flux pipeline", flush=True)
...
def main() -> None:
    ...
    pipeline_cls = import_diffusers_pipeline(args.local_diffusers_src, "FluxPipeline")
